  ...
  if (isLoading) {
    return (
      <section
        ...
        aria-label="Categories loading"
      >
        <div className="w-full py-2">
          <div className="relative">
            {/* Gradient overlays to match Marquee style */}
            <div className="absolute left-0 top-0 bottom-0 w-[60px] z-10 bg-gradient-to-r from-white to-transparent"></div>
            <div className="absolute right-0 top-0 bottom-0 w-[60px] z-10 bg-gradient-to-l from-white to-transparent"></div>
