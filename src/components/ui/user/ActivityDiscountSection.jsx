      ...
      <div className="relative overflow-hidden transition-all duration-300 bg-white border border-gray-200 group rounded-xl hover:border-blue-300 hover:-translate-y-1">
        <Link href={`/activity/${activityItem.id}`} className="block">
          <div className="relative overflow-hidden aspect-[4/3]">
            <Image
              src={
                Array.isArray(activityItem.imageUrls)
                  ? activityItem.imageUrls[0]
                  : activityItem.imageUrls || PLACEHOLDER_DATA_URL
              }
          ...
          <div className="p-3 sm:p-4">
            ...
            <div className="flex items-center gap-1 mb-2 text-xs text-gray-500 sm:mb-3 sm:text-sm">
              ...
              <span className="truncate">
                {activityItem.city || "Location not specified"}
              </span>
            </div>
...
const ActivityDiscountSkeleton = () => (
  <div className="overflow-hidden bg-white border border-gray-200 rounded-xl">
    ...
    <div className="p-3 sm:p-4">
      <div className="h-4 mb-2 bg-gray-200 rounded sm:h-5 sm:mb-3 animate-pulse" />
      <div className="h-3 mb-2 bg-gray-200 rounded sm:h-4 sm:mb-3 animate-pulse" />
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          <div className="h-4 bg-gray-200 rounded sm:h-5 animate-pulse" />
          <div className="h-3 bg-gray-200 rounded sm:h-4 animate-pulse" />
        </div>
        <div className="w-8 h-8 bg-gray-200 rounded-lg sm:w-9 sm:h-9 animate-pulse" />
      </div>
    </div>
  </div>
);
    ...
    <section className="py-20 bg-white" aria-label="Hot deals and discounts">
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="flex flex-col items-start mb-12 text-left">
          ...
          <h2 className="mb-2 text-3xl font-bold tracking-tight text-gray-900 md:text-3xl lg:text-4xl font-title">
            <span className="text-transparent bg-gradient-to-r from-blue-600 to-blue-700 bg-clip-text">
              Hot Deals
            </span>{" "}
            & Discounts
          </h2>
          <p className="max-w-2xl text-sm text-gray-600 md:text-lg">
            Special prices for your next great adventure! Don't miss out on
        ...
        >
          <Carousel
            className="w-full"
            opts={{ align: "start", loop: discountedActivities.length > 5 }}
          >
