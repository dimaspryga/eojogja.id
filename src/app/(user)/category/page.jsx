      ...
      <Link href={`/category/${item.id}`} className="block h-full group">
        <div className="flex flex-col w-full h-full overflow-hidden transition-all duration-300 bg-white border border-gray-200 rounded-xl hover:border-blue-300 hover:-translate-y-1">
          ...
          <div className="flex flex-col flex-grow p-3 sm:p-4">
            ...
            <Button
              size="sm"
              className="w-full mt-3 text-white transition-all duration-200 bg-blue-600 rounded-lg sm:mt-4 hover:bg-blue-700 hover:scale-105"
            >
              Explore Category
            </Button>
          </div>
...
const CategoryPage = () => {
  ...
  const isLoading =
    authLoading || isCategoryLoading || isActivityLoading || !hasMounted;
        ...
        <div className="container px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="mb-8 text-center">
            ...
            <p className="max-w-2xl mx-auto text-sm text-gray-600 sm:text-base">
              Find the perfect adventure by browsing through our curated
              categories
            </p>
          </div>
