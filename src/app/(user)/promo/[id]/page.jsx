        ...
        <div className="container px-4 py-8 mx-auto max-w-7xl">
          ...
          <div className="flex flex-col gap-6 lg:flex-row">
            <div className="w-full space-y-4 lg:w-2/3">
              <Skeleton className="w-full h-64 bg-white border border-gray-200 rounded-lg" />
              <Skeleton className="w-full h-32 bg-white border border-gray-200 rounded-lg" />
              <Skeleton className="w-full h-20 bg-white border border-gray-200 rounded-lg" />
            </div>
            <div className="w-full lg:w-1/3">
              <div className="sticky top-24">
                <Skeleton className="w-full h-48 bg-white border border-gray-200 rounded-lg" />
              </div>
            </div>
          </div>
        </div>
  ...
  return (
    ...
    >
        ...
        <div className="flex flex-col gap-8 lg:flex-row">
          <div className="w-full lg:w-2/3">
            ...
            >
              <div className="relative w-full h-80 md:h-96">
                <Image
                  src={
                    Array.isArray(detailPromo.imageUrls)
                      ? detailPromo.imageUrls[0]
                      : detailPromo.imageUrls || PLACEHOLDER_DATA_URL
                  }
            ...
            >
              <h1 className="mb-6 text-2xl font-bold tracking-tight text-gray-900 md:text-3xl lg:text-4xl font-title">
                {detailPromo.title}
              </h1>
            ...
            >
              ...
              <div className="p-8 leading-relaxed prose-sm text-gray-600 max-w-none">
          ...
          <div className="w-full lg:w-1/3">
            <div className="sticky top-24">
              ...
              >
                <h3 className="mb-6 text-lg font-bold tracking-tight text-gray-900 md:text-xl">
                  Use this promo code
                </h3>

                <div className="flex items-center justify-between p-4 border-2 border-blue-200 border-dashed rounded-xl bg-gradient-to-r from-blue-50 to-blue-100">
                ...
                <Button
                  asChild
                  className="w-full py-4 mt-6 text-lg font-bold text-white transition-all duration-300 bg-blue-600 shadow-lg hover:bg-blue-700 hover:shadow-xl rounded-xl"
                >
      ...
      {activity && activity.length > 0 && (
        <div className="container px-4 py-8 mx-auto max-w-7xl">
          <h2 className="mb-8 text-xl font-bold tracking-tight text-gray-900 md:text-2xl lg:text-3xl">
                      ...
                      >
                        <div className="flex flex-col h-full overflow-hidden transition-all duration-300 border border-blue-100 shadow-lg bg-white/90 backdrop-blur-sm rounded-3xl hover:shadow-2xl hover:border-blue-300 hover:-translate-y-2">
                            ...
                            <Image
                              src={
                                Array.isArray(rec.imageUrls)
                                  ? rec.imageUrls[0]
                                  : rec.imageUrls || PLACEHOLDER_DATA_URL
                              }
                              alt={rec.title}
                              fill
                          ...
                          <div className="flex flex-col flex-grow p-6">
                            ...
                            <h3
                              className="h-12 mb-3 text-lg font-bold text-gray-900 transition-colors duration-200 line-clamp-2 group-hover:text-blue-600"
                              title={rec.title}
                            >
